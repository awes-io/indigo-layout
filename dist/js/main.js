(function () {
    ...
    var __vue_render__$2 = function() {
      ...
      return _c(
        "transition",
        {
          ...
          on: {
            "after-enter": _vm.initBottomObserver,
            "after-leave": _vm.destroyBottomObserver
          }
        },
        [
          _vm.isOpened
            ? _c(
                "div",
                {
                  class: [
                    "modal",
                    { "modal_bottom-visible": _vm.isBottomVisible },
                    { modal_fullscreen: _vm.fullscreen }
                  ]
                },
                [
                  _c(
                    "div",
                    {
                      ...
                      class: { "modal-fade__translate": !_vm.fullscreen },
                      attrs: { role: "dialog" }
                    },
                    [
                      _c("div", { staticClass: "modal__header" }, [
                        ...
                        _c(
                          "button",
                          {
                            ...
                            attrs: {
                              type: "button",
                              title: _vm.$lang.MODAL_CLOSE,
                              "aria-label": _vm.$lang.MODAL_CLOSE
                            },
                            on: {
                      ...
                      _vm._v(" "),
                      _c("div", { ref: "bottom", staticClass: "modal__bottom" })
                    ]
                  )
                ]
              )
    ...
    __vue_render__$2._withStripped = true;
      ...
      var modalWindow = normalizeComponent(
